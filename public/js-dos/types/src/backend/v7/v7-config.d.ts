export declare const endpointBase =
  'https://kdhkdsv558.execute-api.eu-central-1.amazonaws.com/dev';
...
export declare const checkoutEndpoint =
  'https://js-dos.com/checkout/index.html';
