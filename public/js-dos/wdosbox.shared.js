  ...
  return function (WDOSBOX) {
    ...
    function emsc_ws_client_sound_init(freq) {
      if (Module.directSound !== undefined) {
        ...
        Module.sendMessage('ws-sound-init', {
          freq: freq,
    ...
    function emsc_ws_client_sound_push(samples, num_samples) {
      ...
      if (Module.directSound !== undefined) {
        ...
        buffer.set(
          Module.HEAPF32.subarray(samples / 4, samples / 4 + num_samples),
          0
        );
        Module.directSound.active =
          (Module.directSound.active + 1) % Module.directSound.ringSize;
      } else {
    ...
    function ws_init_runtime(sessionId) {
      ...
      if (worker) {
        if (
          ...
          for (var i = 0; i < Module.directSound.ringSize; ++i) {
            var sharedBuffer = new SharedArrayBuffer(
              Module.directSound.bufferSize * 4
            );
        ...
        for (var i = 0; i < Module.directSound.ringSize; ++i) {
          Module.directSound.buffer.push(
            new Float32Array(Module.directSound.bufferSize)
          );
        }
      }
    ...
    var PThread = {
      ...
      runWithoutMainThreadQueuedCalls: function (func) {
        GROWABLE_HEAP_I32()[__emscripten_allow_main_runtime_queued_calls >> 2] =
          0;
        try {
          func();
        } finally {
    ...
    function ___syscall_fstat64(fd, buf) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(7, 1, fd, buf);
      try {
        var stream = SYSCALLS.getStreamFromFD(fd);
    ...
    function ___syscall_ftruncate64(fd, low, high) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(9, 1, fd, low, high);
      try {
    ...
    function ___syscall_getcwd(buf, size) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(10, 1, buf, size);
      try {
        if (size === 0) return -28;
        var cwd = FS.cwd();
    ...
    function ___syscall_listen(fd, backlog) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(13, 1, fd, backlog);
      try {
        var sock = getSocketFromFD(fd);
    ...
    function ___syscall_mkdir(path, mode) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(15, 1, path, mode);
      try {
        path = SYSCALLS.getStr(path);
    ...
    function ___syscall_stat64(path, buf) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(23, 1, path, buf);
      try {
        path = SYSCALLS.getStr(path);
    ...
    function ___syscall_unlink(path) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(24, 1, path);
      try {
        path = SYSCALLS.getStr(path);
        FS.unlink(path);
        return 0;
    ...
    function _emscripten_force_exit(status) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(26, 1, status);
      noExitRuntime = false;
    ...
    function getHostByName(name) {
      ...
      GROWABLE_HEAP_I32()[(addrListBuf + 8) >> 2] = inetPton4(
        DNS.lookup_name(name)
      );
    ...
    function _gethostbyname(name) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(34, 1, name);
    ...
    var _malloc = (Module['_malloc'] = function () {
      return (_malloc = Module['_malloc'] = Module['asm']['Ea']).apply(
        null,
        arguments
      );
    });
    ...
    var _zip_to_fs = (Module['_zip_to_fs'] = function () {
      return (_zip_to_fs = Module['_zip_to_fs'] = Module['asm']['Ia']).apply(
        null,
        arguments
      );
    });
    ...
    var _addKey = (Module['_addKey'] = function () {
      return (_addKey = Module['_addKey'] = Module['asm']['Pa']).apply(
        null,
        arguments
      );
    });
    var _mouseMove = (Module['_mouseMove'] = function () {
      return (_mouseMove = Module['_mouseMove'] = Module['asm']['Qa']).apply(
        null,
        arguments
      );
    });
    ...
    var _mouseSync = (Module['_mouseSync'] = function () {
      return (_mouseSync = Module['_mouseSync'] = Module['asm']['Sa']).apply(
        null,
        arguments
      );
    });
    ...
    var _runRuntime = (Module['_runRuntime'] = function () {
      return (_runRuntime = Module['_runRuntime'] = Module['asm']['Ua']).apply(
        null,
        arguments
      );
    });
    ...
    var _main = (Module['_main'] = function () {
      return (_main = Module['_main'] = Module['asm']['$a']).apply(
        null,
        arguments
      );
    });
    var _dumpMemory = (Module['_dumpMemory'] = function () {
      return (_dumpMemory = Module['_dumpMemory'] = Module['asm']['ab']).apply(
        null,
        arguments
      );
    });
    ...
    var _htons = (Module['_htons'] = function () {
      return (_htons = Module['_htons'] = Module['asm']['mb']).apply(
        null,
        arguments
      );
    });
    ...
    var _ntohs = (Module['_ntohs'] = function () {
      return (_ntohs = Module['_ntohs'] = Module['asm']['rb']).apply(
        null,
        arguments
      );
    });
    ...
    var stackSave = (Module['stackSave'] = function () {
      return (stackSave = Module['stackSave'] = Module['asm']['vb']).apply(
        null,
        arguments
      );
    });
    ...
    var stackAlloc = (Module['stackAlloc'] = function () {
      return (stackAlloc = Module['stackAlloc'] = Module['asm']['xb']).apply(
        null,
        arguments
      );
    });
    var dynCall_vi = (Module['dynCall_vi'] = function () {
      return (dynCall_vi = Module['dynCall_vi'] = Module['asm']['yb']).apply(
        null,
        arguments
      );
    });
    var dynCall_v = (Module['dynCall_v'] = function () {
      return (dynCall_v = Module['dynCall_v'] = Module['asm']['zb']).apply(
        null,
        arguments
      );
    });
    var dynCall_ii = (Module['dynCall_ii'] = function () {
      return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['Ab']).apply(
        null,
        arguments
      );
    });
